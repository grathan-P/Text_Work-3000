...
##Features
> One-click transforms: Uppercase, Lowercase, Remove Extra Spaces, Copy, Clear
> Live stats: word/character counts and estimated reading time with inline preview
> Light/Dark mode with localStorage persistence and instant body background updates
> Alerts for every action; buttons disable when input is empty
